...
namespace Program5_9
{
    public partial class Form1 : Form 
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            showPictureBox(n1 , pictureBox1); //呼叫showPictureBox方法，顯示第一個圖片框中的圖片

            showPictureBox(n2 , pictureBox2); //呼叫showPictureBox方法，顯示第二個圖片框中的圖片

        }

        private void showPictureBox(int n,PictureBox pic) //void是不用回傳值時使用
        {
